...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because le is used inside a block code and the declarition of rando nariable was inside while block but but it consoled log out of while block
  console.log(viewed);
